...
8. 在执行前，检查路径、命名、Unity 版本、渲染管线、资源类型、脚本用途等前置条件是否齐全。
...
识别当前请求属于项目初始化、`.gitignore`、`.editorconfig`、ScriptableObject、prefab、Shader、Unity C# 代码中的哪一种或哪几种。

### 第二步：检查前置条件

确认 Unity 版本、资源路径、命名规则、渲染管线、目标文件、脚本用途等信息是否齐全。
