...
- 编排流程：
```
// main.agent 与 其他agent 的伪代码示例
main() {
  var res = agent_1(input)
  var res2 = agent_2(res) or ... or agent_4(res)
  ...
  var finalRes = agent_final(res2)
  return finalRes
}

// agent 与 skills 的伪代码示例
agent(input) {
  var res = skill(input)
  var res2 = skill_2(res) or ... or skill_n(res)
  ...
  var finalRes = skill_final(res2)
  return finalRes
}
```
