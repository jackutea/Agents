...
agents: [Architecture Agent, Git Agent, Linux MySQL Agent, Linux Nginx Agent, Linux Redis Agent, Milestone Agent, MySQL Agent, Network Agent, Redis Agent, Render Agent, Style Agent, Unity UGUI, WeChat Mini Game Agent, Game Design Agent]
user-invocable: true
---
